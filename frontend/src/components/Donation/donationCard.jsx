...
const Card = ({ children, className }) => (
  <div
    className={`w-full max-w-sm rounded-lg overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl ${className}`}
  >
    {children}
  </div>
);
...
const CardContent = ({ children, className }) => (
  <div className={`p-6 bg-background ${className}`}>{children}</div>
);
      ...
      <Card className="mt-4 ml-4">
        ...
        <CardContent>
          <div className="flex items-center justify-between mb-2">
            <h3 className="text-lg font-libre-franklin font-semibold">
              {donation.foodType}
            </h3>
