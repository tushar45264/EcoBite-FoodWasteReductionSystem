    ...
    return (
        <section className="py-12 md:py-20">
            <div className="container mx-auto px-4 md:px-6">
                <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8">Your Donations</h2>
                    ...
                    <table className="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody className="bg-white divide-y divide-gray-200">
                            {donations.map((donation, index) => (
                                <tr key={index}>
                                    <td className="px-6 py-4 whitespace-nowrap">{new Date(donation.expirationDate).toLocaleDateString()}</td>
                                    <td className="px-6 py-4 whitespace-nowrap">{donation.foodType}</td>
                                    <td className="px-6 py-4 whitespace-nowrap">{donation.pickupLocation}</td>
