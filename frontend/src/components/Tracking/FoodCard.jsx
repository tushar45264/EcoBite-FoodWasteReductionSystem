    ...
    <div className="max-w-sm rounded overflow-hidden shadow-lg p-4">
      ...
      <div className="px-6 py-4">
        ...
        <p className="text-gray-700 text-base">
          Expires on: {donation.expirationDate}
        </p>
      ...
      <div className="px-6 flex flex-row items-center pt-4 pb-2">
        ...
        <button
          onClick={isClick}
          className="bg-red-500 ml-2 text-white font-bold py-2 px-4 rounded"
        >
          Cancel
        </button>
        <button
          onClick={handlePickUp}
          className="bg-green-500 ml-2 text-white font-bold py-2 px-4 rounded"
        >
          Pick Up
        </button>
      </div>
