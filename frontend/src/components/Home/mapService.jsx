...
const MapSection = () => {
  const mapboxToken = "pk.eyJ1IjoidHVzaGFyNDUiLCJhIjoiY2xtOWpoZnN1MGtzbDNwbzVnZHU2dzlhcCJ9.ajMoNWOXT4hbizwr9nvxUg";
      ...
      >
        ...
        >
          <div className="space-y-3">
            ...
            >
              Our interactive map allows you to track food donations and find
              nearby drop-off locations, making it easy to contribute to the
              cause.
            </motion.p>
          </div>
          <motion.div
