        ...
        <nav className="hidden gap-6 items-center md:flex">
          ...
          {user.user ? (
            <button
              ...
              className="text-sm bg-green-500 hover:bg-green-400 rounded text-white py-2 px-2 font-medium underline-offset-4"
            >
              Logout
            </button>
          ) : (
            <Link to="/login">
              <button className="text-sm bg-green-500 hover:bg-green-400 rounded text-white py-2 px-2 font-medium underline-offset-4">
                Join Now
              </button>
            </Link>
          )}
